class NotificationRelayJob < ApplicationJob
  ...
  def perform(notification)
    ...
    if notification.action == "ping_to_home"
    	ActionCable.server.broadcast "push_notifications:#{notification.recipient_id}", { title: notification.title, description: notification.description, url: notification.url, icon_url: assets_path_helper.asset_path("missing.png") }
